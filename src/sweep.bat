...
@REM py -3.8 main.py --just_input True  --channels 850 --replicas 9 --patterns 9 --input_name "Heidelberg" --dir hei_large
FOR %%i IN (.5) DO (
    FOR %%z IN (Maass,STSP,STDP,LSTP) DO (
        FOR %%w IN (500) DO (
            FOR %%v IN (.3) DO (
                py -3.8 ./main.py --learning %%z  --neurons %%w --topology rnd --rndp %%v --dir hei_large2 --length 800 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay 1.5 --refractory 0 --replicas 9 --patterns 3
                py -3.8 ./main.py --learning %%z  --neurons %%w --dims 10 10 5 --topology geo  --dir hei_large2 --length 800 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay 1.5 --refractory 0 --replicas 9 --patterns 3
                py -3.8 ./main.py --learning %%z  --neurons %%w --beta 0.25 --topology smw --dir hei_large2 --length 800 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay 1.5 --refractory 0 --replicas 9 --patterns 3
            )
        )
    )
)
    ...
    FOR %%z IN (Maass,STSP,STDP,LSTP) DO (
        FOR %%y IN (0,3) DO (
            FOR %%x IN (0,1.5) DO (
                FOR %%w IN (135) DO (
                    FOR %%v IN (.2,.3,.4,.5) DO (
                        py -3.8 ./main.py --learning %%z  --neurons %%w --topology rnd --rndp %%v --dir hei_large2 --length 700 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay %%x --refractory %%y --replicas 3 --patterns 3
                        py -3.8 ./main.py --learning %%z  --neurons %%w --dims 15 3 3 --topology geo  --dir hei_large2 --length 700 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay %%x --refractory %%y --replicas 3 --patterns 3
                        py -3.8 ./main.py --learning %%z  --neurons %%w --beta 0.25 --topology smw --dir hei_large2 --length 700 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay %%x --refractory %%y --replicas 3 --patterns 3
                    )
                )
            )
        )
...
FOR %%i IN (.2,.3,.4,.5) DO (
    FOR %%z IN (Maass,STSP,STDP,LSTP) DO (
        FOR %%w IN (1000) DO (
            FOR %%v IN (.2,.3,.4,.5) DO (
                py -3.8 ./main.py --learning %%z  --neurons %%w --topology rnd --rndp %%v --dir hei_large2 --length 700 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay 1.5 --refractory 0 --replicas 3 --patterns 3
                py -3.8 ./main.py --learning %%z  --neurons %%w --dims 10 10 10 --topology geo  --dir hei_large2 --length 700 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay 1.5 --refractory 0 --replicas 3 --patterns 3
                py -3.8 ./main.py --learning %%z  --neurons %%w --beta 0.25 --topology smw --dir hei_large2 --length 700 --input_name "Heidelberg" --res_sparsity %%v --input_sparsity %%i --delay 1.5 --refractory 0 --replicas 3 --patterns 3
            )
        )
    )
)
